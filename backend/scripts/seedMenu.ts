  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        choices: [
          { name: 'None', price: 0, isDefault: true },
          { name: 'Grilled pork with pate', price: 2.00 },
          { name: 'Char-siu pork with pate', price: 2.00 },
          { name: 'Chicken', price: 2.00 },
          { name: 'Crispy chicken', price: 2.00 },
          { name: 'Beef', price: 2.00 },
          { name: 'Crispy beef', price: 2.00 },
          { name: 'Fried egg', price: 0 },
          { name: 'Tofu', price: 0 },
        ],
      },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        choices: [
          { name: 'None', price: 0, isDefault: true },
          { name: 'Grilled pork', price: 2.00 },
          { name: 'Char-siu pork', price: 2.00 },
          { name: 'Beef', price: 2.00 },
          { name: 'Crispy beef', price: 2.00 },
          { name: 'Chicken', price: 2.00 },
          { name: 'Crispy chicken', price: 2.00 },
          { name: 'Prawn', price: 2.00 },
          { name: 'Tofu', price: 0 },
          { name: 'Veggie', price: 0 },
        ],
      },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        choices: [
          { name: 'None', price: 0, isDefault: true },
          { name: 'Chicken breast', price: 2.00 },
          { name: 'Chicken wings', price: 2.00 },
          { name: 'Crispy beef', price: 2.00 },
          { name: 'Tofu', price: 0 },
        ],
      },
